...
If CNN.rsCmdEtiquetas.EOF <> True Then
    ...
    TicketGem = CNN.rsCmdEtiquetas!TicketGem         '''  TicketGem = "161101"
    IdJC = CNN.rsCmdEtiquetas!Oma_Id
    'OF = CNN.CmdEtiquetas!OF
...
Else
        ...
        If CNN.rsCmdInsertDetOM.EOF = True Then
            CNN.rsCmdInsertDetOM.AddNew
                ...
                CNN.CmdBuscaPKL_Programa (TicketGem) ', (Fecha)           '(IdHora),
                ...
                CNN.rsCmdInsertDetOM!EmpleadoId = EmpleadoId ''''= "011-056" 'EmpleadoId
